...
export default function Jobs() {
    ...
    return (<>
        <Section>
            ...
            <Marquee delay={0} speed={1000} gradient={false} pauseOnHover={false}/*  style={{display: 'flex', gap: '50px'}} */>
                {
                    Logos.map(
                        (logo, index) =>
            ...
            <Marquee delay={0} speed={1000} gradient={false} direction={'right'} pauseOnHover={false} style={{ display: 'flex', gap: '50px' }}>
                {
                    Logos.map(
                        (logo, index) =>
